...
const TrackingResolver = require('./TrackingResolvers');
const RutaLastSeenResolver = require('./RutaLastSeenResolvers');
...
module.exports = {
    ...
    Mutation: {
        ...
        ...TrackingResolver.Mutation,
        ...RutaLastSeenResolver.Mutation
    }
};